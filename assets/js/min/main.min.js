!function(e){"use strict";e(function(){function t(t,s){var a=e(t).find('input[type="search"]').length?e(t).find('input[type="search"]'):e(t).find('input[type="text"]'),n=e(t).find("form");if(a.length){e(t).addClass("ysm-active");var r={id:"",serviceUrl:ysm_L10n.ajaxurl,layout:"",maxHeight:600,minChars:3,loaderIcon:ysm_L10n.loader_icon},i=e.extend({},r,s);e('<div class="smart-search-results"></div>').appendTo(n);var o=n.find(".smart-search-results").css({maxHeight:i.maxHeight+"px",width:a.outerWidth()+"px"});navigator.userAgent.indexOf("Windows")!==-1&&navigator.userAgent.indexOf("Firefox")!==-1&&o.addClass("smart-search-firefox"),n.on("submit",function(t){var s=a.val();if(""===s||s.length<i.minChars)return!1;var n=e(this).attr("action");s=s.replace(/\s/g,"+"),n+="?s="+s+"&search_id="+i.id,"product"===i.layout&&(n+="&post_type=product"),t.preventDefault(),location.href=n}),a.devbridgeAutocomplete({minChars:i.minChars,appendTo:o,serviceUrl:i.serviceUrl,maxHeight:i.maxHeight,dataType:"json",deferRequestBy:100,noCache:!1,containerClass:"smart-search-suggestions",triggerSelectOnValidInput:!1,showNoSuggestionNotice:!!i.no_results_text.length,noSuggestionNotice:i.no_results_text,formatResult:function(e,t){return e.data},onSearchStart:function(){a.css({"background-image":"url("+i.loaderIcon+")","background-repeat":"no-repeat","background-position":"50% 50%"})},onSelect:function(e){e.id!=-1&&(window.location.href=e.url)},transformResult:function(t){var s="string"==typeof t?e.parseJSON(t):t;a.val();return""!=s.view_all_link&&(o.find(".smart-search-view-all-holder").length||o.addClass("has-viewall-button").append('<div class="smart-search-view-all-holder"></div>'),o.find(".smart-search-view-all-holder").html(s.view_all_link).show()),s},onSearchComplete:function(e,t){a.css("background-image","none"),t.length>0?setTimeout(function(){var e=o.find(".smart-search-suggestions"),t=parseInt(o.css("max-height"),10),s=e[0];o.height(s.scrollHeight>t?t:s.scrollHeight),o.nanoScroller({contentClass:"smart-search-suggestions",alwaysVisible:!1,iOSNativeScrolling:!0}),e.height("auto"),o.find(".smart-search-view-all-holder").length&&o.find(".smart-search-view-all-holder").show()},50):i.no_results_text.length?(o.css({maxHeight:"auto",height:40}).nanoScroller({contentClass:"smart-search-suggestions",stop:!0}),o.find(".smart-search-suggestions").height(40),o.find(".smart-search-view-all-holder").hide()):(o.find(".smart-search-suggestions").height(0),o.find(".smart-search-view-all-holder").hide())},onSearchError:function(e,t,s,a){o.css({maxHeight:"auto",height:0}).nanoScroller({contentClass:"smart-search-suggestions",stop:!0}),o.find(".smart-search-view-all-holder").hide()},onInvalidateSelection:function(){},onHide:function(){o.css({maxHeight:"auto",height:0}).nanoScroller({contentClass:"smart-search-suggestions",stop:!0}),o.find(".smart-search-view-all-holder").hide()}}).on("focus",function(){a.devbridgeAutocomplete().onValueChange()})}}if(1==ysm_L10n.enable_search){var s=e(".widget.widget_search");s.each(function(){var e={id:"default",serviceUrl:ysm_L10n.ajaxurl+"?action=ysm_default_search",layout:ysm_L10n.layout,maxHeight:400,minChars:ysm_L10n.char_count,no_results_text:ysm_L10n.no_results_text};t(this,e)})}if(1==ysm_L10n.enable_product_search){var s=e(".widget.woocommerce.widget_product_search");s.each(function(){var e={id:"product",serviceUrl:ysm_L10n.ajaxurl+"?action=ysm_product_search",layout:"product",maxHeight:400,minChars:ysm_L10n.product_char_count,no_results_text:ysm_L10n.product_no_results_text};t(this,e)})}var a=e(".ysm-search-widget");a.length&&a.each(function(){var s=e(this).find("form").data("id"),a={id:s,serviceUrl:ysm_L10n.ajaxurl+"?action=ysm_custom_search&id="+s,layout:ysm_L10n["custom_"+s+"_layout"],maxHeight:400,minChars:ysm_L10n["custom_"+s+"_char_count"],no_results_text:ysm_L10n["custom_"+s+"_no_results_text"]};t(this,a)})})}(jQuery);
