<div id="ysm_w_settings_fields" class="ysm-widget-settings-tab" style="display: none">
	...
	<table class="form-table">
		...
		<?php if ( $w_id !== 'product' ) { ?>
			...
			<th class="ysm-widget-settings-th"><?php esc_html_e( 'Post Types', 'smart_search' ); ?></th>
		...
		<th class="ysm-widget-settings-th"><?php esc_html_e( 'Product Variations', 'smart_search' ); ?></th>
		...
		<th class="ysm-widget-settings-th"><?php esc_html_e( 'Fields', 'smart_search' ); ?></th>
		...
		<th class="ysm-widget-settings-th"><?php esc_html_e( 'Restrictions', 'smart_search' ); ?></th>
