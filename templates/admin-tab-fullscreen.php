<div id="fullscreen_tab" class="ymapp-settings__content">
    <div data-href="#fullscreen_tab" class="sws_tab_mobile_heading js-sws-tab-mobile-heading">
        <div class="sws_tab_mobile_heading__inner">
            ...
            <?php 
echo __( 'Fullscreen Mode', 'smart-woocommerce-search' );
?>
        </div>
    </div>
...
esc_html_e( 'Recommended Products', 'smart-woocommerce-search' );
?></th>
            <?php 
$product_choices = [];
...
?>
            ...
            <th class="ymapp-settings__title"><?php 
esc_html_e( 'Selected Categories', 'smart-woocommerce-search' );
?></th>
...
?>
            ...
            <th class="ymapp-settings__title"><?php 
esc_html_e( 'Promo banner', 'smart-woocommerce-search' );
?></th>
...
?>
        ...
        <a class="ymapp-settings__doc_link" href="https://www.wpsmartsearch.com/docs/fullscreen-mode/" target="_blank">
