    ...
    <div class="sws-promo-container updated" data-dismiss="<?php echo esc_attr(SWS_PLUGIN_UPDATE_NOTICE) ?>">
        <div class="sws-promo-container__inner">
            ...
            <div class="sws-promo-container__right">
                ...
                <p>
                    <strong>Fullscreen Mode:</strong> the search bar and results now look stunning in a fullscreen popup. Learn more
                    <br>
                ...
                <p>
                    ...
                    <br>
                    <a href="https://www.wpsmartsearch.com/docs/layout-settings/" target="_blank">Learn more</a>
                </p>
                <p>
