    ...
    foreach ( $css_classes as $css_class ) {
        ...
        if ( isset( $v['settings']['input_border_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.search-field[type="search"]'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_thumb_size'] ) ) {
            ...
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-suggestions .smart-search-post-icon'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_border_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-popup'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_bg_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-results'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_title_text_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-post-title'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_desc_text_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-post-excerpt'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_view_all_link_text_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-view-all'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['category_text_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-post-category'),
                'props'     => array(
        ...
        if ( isset( $v['settings']['popup_price_text_color'] ) ) {
            Ysm_Style_Generator::add_rule( $css_class, array(
                'selectors' => array('.smart-search-post-price', '.smart-search-post-price .woocommerce-Price-amount', '.smart-search-post-price .woocommerce-Price-currencySymbol'),
                'props'     => array(
